...
function sizeVid(myW, myH){
    ...
    myhtml += '<div id="vidInfo" style="border: 1px solid #ff0000;"><span style="color: #ff0000; font-weight: bold;">Notice: </span>';
    myhtml += '<span style="color: #ffffff;">This video is confidential. Please do not distribute to anyone else.</span></div>';
    myhtml += '<video width="' + thisW + 'px" height="' + thisH + 'px" controls="true" autoplay>';
